...
from .views import ProfilePageView, StaffUserListView, PasswordChangeSuccessfulView, MyCustomPasswordChangeView

urlpatterns = [
    # path('signup/', SignupPageView.as_view(), name='signup'),
    path('profile/', ProfilePageView.as_view(), name='profile'),
    path('user-list/', StaffUserListView.as_view(), name='student_list'),
